...
class Todo {
    ...
    _removePreviousActiveNav() {
        document.querySelectorAll(".nav").forEach((navBtn)=>{
            if (navBtn.classList.contains("nav-active")) navBtn.classList.remove("nav-active");
        });
    }
    _toggleActiveNav(e) {
    ...
    _renderTodoItem(filter) {
        let filteredTodos = [];
        let html = "";
        if (this.#todoLists) switch(filter){
            case "all":
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../images/icon-sun.svg":"dXOZj","../images/icon-moon.svg":"3Lcyu"}],"gkKU3":[function(require,module,exports) {
...
},{}],"dXOZj":[function(require,module,exports) {
module.exports = require("1a06a1b013401e42").getBundleURL("dH6Y1") + "icon-sun.2e69e59d.svg" + "?" + Date.now();

},{"1a06a1b013401e42":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
module.exports = require("64bd746fff127e13").getBundleURL("dH6Y1") + "icon-moon.29939b81.svg" + "?" + Date.now();

},{"64bd746fff127e13":"lgJ39"}]},["ko2YT","dUn2x"], "dUn2x", "parcelRequire546b")
